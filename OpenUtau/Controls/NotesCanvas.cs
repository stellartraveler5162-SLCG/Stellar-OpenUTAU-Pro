    ...
    class NotesCanvas : Control {
        ...
        private void RenderNoteBody(UNote note, NotesViewModel viewModel, DrawingContext context) {
            ...
            var gradient = new LinearGradientBrush {
                ...
                Opacity = baseBrush.Opacity,
            };
            gradient.GradientStops.Add(new GradientStop(((ISolidColorBrush)baseBrush).Color, 0));
            gradient.GradientStops.Add(new GradientStop(((ISolidColorBrush)baseBrush).Color, 0.75));
            gradient.GradientStops.Add(new GradientStop(Color.FromRgb(
                (byte)(((ISolidColorBrush)baseBrush).Color.R * 70 / 100),
                (byte)(((ISolidColorBrush)baseBrush).Color.G * 70 / 100),
                (byte)(((ISolidColorBrush)baseBrush).Color.B * 70 / 100)), 1));
            context.DrawRectangle(gradient, null, new Rect(leftTop, rightBottom), 4, 4);
