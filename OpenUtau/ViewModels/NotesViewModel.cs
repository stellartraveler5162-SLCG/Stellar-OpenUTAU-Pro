...
namespace OpenUtau.App.ViewModels {
    ...
    public class NotesViewModel : ViewModelBase, ICmdSubscriber {
        ...
        [Reactive] public bool ParameterEditingMode { get; set; }
        public ReactiveCommand<string, Unit> SelectToolCommand { get; }
        public ReactiveCommand<string, Unit> SetModeCommand { get; }
        ...
        public NotesViewModel() {
            ...
            SelectToolCommand = ReactiveCommand.Create<string>(index => {
                ...
                KnifeTool = index == "5";
                ParameterEditingMode = index == "4" || index == "4+" || index == "4++" || index == "4+++";
            });

            SetModeCommand = ReactiveCommand.Create<string>(mode => {
                ParameterEditingMode = mode == "param";
                if (mode == "param") {
                    CursorTool = false; PenTool = false; PenPlusTool = false;
                    EraserTool = false; KnifeTool = false;
                    DrawPitchTool = true;
                    OverwritePitchTool = false;
                    DrawLinePitchTool = false;
                    OverwriteLinePitchTool = false;
