    ...
    public class PathManager : SingletonBase<PathManager> {
        public PathManager() {
            ...
            if (OS.IsMacOS()) {
                ...
                DataPath = Path.Combine(userHome, "Library", "Stellar OpenUTAU Pro");
                CachePath = Path.Combine(userHome, "Library", "Caches", "Stellar OpenUTAU Pro");
                ...
                DataPath = Path.Combine(dataHome, "Stellar OpenUTAU Pro");
                ...
                CachePath = Path.Combine(cacheHome, "Stellar OpenUTAU Pro");
                HomePathIsAscii = true;
            } else {
